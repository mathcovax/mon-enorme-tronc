...
export type response_body_44_6 = {
    commandId: string;
    quantity: number;
    createdAt?: string;
}[]
...
export type response_body_75_0 = ({
    type: "CHECKBOX" | "RADIO";
    name: string;
    values: {
        value: string;
...
export type response_body_76_2 = {
    id: string;
    name: string;
    price: number;
    shortDescription: string;
...
export type response_body_77_0 = string

export type response_77_0 = {
    code: 200;
    ok: true;
    info: "fullProductSheetCount";
} & {body: response_body_77_0};
...
export type response_body_79_1 = {
    id: string;
    name: string;
    price: number;
    shortDescription: string;
