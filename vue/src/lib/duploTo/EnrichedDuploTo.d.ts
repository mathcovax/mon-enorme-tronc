...
export type response_body_49_2 = {
    name: string;
    categories?: {
        categoryName: string;
    }[] | undefined;
...
export type response_body_64_3 = {
    userId: string;
    productSheetId: string;
    quantity: number;
    createdAt?: string;
...
export type response_body_66_2 = {
    id: string;
    name: string;
    label: string | null;
    ownerId: string;
