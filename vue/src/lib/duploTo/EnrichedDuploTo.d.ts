...
export type request_body_984703381013768 = string

export type response_984703387642088 = {
    code: 401;
    ok: false;
    info: "firebase.token.invalide";
} & {body: undefined};

export type response_body_984703389563534 = string

export type response_984703389558875 = {
    code: 200;
    ok: true;
    info: "user.login";
} & {body: response_body_984703389563534};

export type response_body_984703390064008 = string

export type response_984703390060782 = {
    code: 200;
    ok: true;
    info: "user.register";
} & {body: response_body_984703390064008};
...
export type DefEnrichedDuplojsTo = {
	path: "/login",
	method: "POST",
	body: request_body_984703381013768,
	parameters: undefined,
	response: response_984703387642088
		| response_984703389558875
		| response_984703390060782,
};
