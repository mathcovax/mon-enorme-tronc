...
export type request_body_1038262870547560 = string

export type response_1038262875979670 = {
    code: 401;
    ok: false;
    info: "firebase.token.invalide";
} & {body: undefined};

export type response_body_1038262880405371 = string

export type response_1038262880394631 = {
    code: 200;
    ok: true;
    info: "user.login";
} & {body: response_body_1038262880405371};

export type response_body_1038262880880759 = string

export type response_1038262880877913 = {
    code: 200;
    ok: true;
    info: "user.register";
} & {body: response_body_1038262880880759};
...
export type DefEnrichedDuplojsTo = {
	path: "/login",
	method: "POST",
	body: request_body_1038262870547560,
	parameters: undefined,
	response: response_1038262875979670
		| response_1038262880394631
		| response_1038262880877913,
};
