...
export type response_body_17_3 = string
...
export type response_body_29_5 = string
...
export type response_body_47_7 = {
    sku: string;
    productSheetId: string;
    organizationId: string;
    warehouseId: string;
...
export type response_body_71_0 = string
