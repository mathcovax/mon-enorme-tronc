...
export type request_body_2337214659367 = string

export type response_2337222241981 = {
    code: 401;
    ok: false;
    info: "firebase.token.invalide";
} & {body: undefined};

export type response_body_2337224895828 = string

export type response_2337224890388 = {
    code: 200;
    ok: true;
    info: "user.login";
} & {body: response_body_2337224895828};

export type response_body_2337225580525 = string

export type response_2337225576367 = {
    code: 200;
    ok: true;
    info: "user.register";
} & {body: response_body_2337225580525};
...
export type DefEnrichedDuplojsTo = {
	path: "/login",
	method: "POST",
	body: request_body_2337214659367,
	parameters: undefined,
	response: response_2337222241981
		| response_2337224890388
		| response_2337225576367,
};
