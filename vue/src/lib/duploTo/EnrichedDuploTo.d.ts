...
export type request_body_120319291345097 = string

export type response_120319295042696 = {
    code: 401;
    ok: false;
    info: "firebase.token.invalide";
} & {body: undefined};

export type response_body_120319296680953 = string

export type response_120319296677437 = {
    code: 200;
    ok: true;
    info: "user.login";
} & {body: response_body_120319296680953};

export type response_body_120319297236680 = string

export type response_120319297233925 = {
    code: 200;
    ok: true;
    info: "user.register";
} & {body: response_body_120319297236680};
...
export type DefEnrichedDuplojsTo = {
	path: "/login",
	method: "POST",
	body: request_body_120319291345097,
	parameters: undefined,
	response: response_120319295042696
		| response_120319296677437
		| response_120319297233925,
};
